...
<head>
  ...
  <script type="text/javascript" src="<?php echo $DOMAIN_URL;?>/contact/package/js/jquery-2.1.3.js"></script>
  <script type="text/javascript" src="<?php echo $DOMAIN_URL;?>/contact/package/js/script.js"></script>
</head>
<style>
header{
  width: 100%;
